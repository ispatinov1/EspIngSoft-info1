...
<!-- Panel listado y gestion de tipos de documento --> 
                <br>
                <br>
                    ...
                    <div class="panel-body">          
                        ...
                        <form id="formCreaTiposDocumento" name="formCreaTiposDocumento" method="POST" action="" enctype="multipart/form-data" >
                            ...
                            <div id="divNombreTipoDocumento" class="form-group" >
                                ...
                                <input type="text" id="txtNombreTipoDocumento" name="txtNombreTipoDocumento" class="form-control" maxlength="50" readonly="" placeholder="Tipo de documento" value="<!--{$resultado.sol_tipodocumento_nombre}-->"></input>
                            </div>                                             
                            <div id="divDescripcionTipoDocumento" class="form-group" >
                                ...
                                <textarea id="txtDescripcionTipoDocumento" name="txtDescripcionTipoDocumento" class="form-control" rows="2" maxlength="249" readonly="" placeholder="Descripción del tipo asociado al tipo de solicitud" data-toggle="tooltip" data-placement="bottom" title="Puede registrar información acerca del tipo de documento que va a registrar." >
<!--{$resultado.sol_tipodocumento_descripcion}-->
                                </textarea>
                            </div>
                            <div class="row text-center well well-md" >                                  
                                <div id="divBtnEliminarTipoDocumento" class="col-md-6" >
                                    <input type="submit" id="btnEliminarTipoDocumento" name="btnEliminarTipoDocumento" class="btn btn-info" value="Eliminar tipo de documento" >
                                </div> 
