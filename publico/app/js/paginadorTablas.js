/* Adaptado de los casos de ejemplo de la libreria tablesorter FORK 2.0 (GPL-v3)
 * http://mottie.github.io/tablesorter/docs/ 
 */

//function sortTabla(){
$(function () {
    $('#tblGestionSolicitudes').tablesorter({
    //$('#tblCrearCeremonias').tablesorter({
    //$('#tblSolicitudes #tblCrearCeremonias').tablesorter({
        // *** APPEARANCE ***
	...
	dateFormat: "ddmmyyyy",
        ...
        output: '{endRow} de {totalRows} solicitudes',
