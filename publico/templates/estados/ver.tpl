                        ...
                        <div class="well">                                
                            <form id="formCreaEstadosTipoSolicitud" name="formCreaEstadosTipoSolicitud" method="POST" action="" enctype="multipart/form-data" >
                                ...
                                <div id="divNombreEstadoTipoSolicitud" class="form-group" >
                                    ...
                                    <input type="text" id="txtNombreEstadoTipoSolicitud" name="txtNombreEstadoTipoSolicitud" class="form-control" maxlength="50" placeholder="Estado por tipo de solicitud" value="<!--{$resultado.sol_estadotsolicitud_nombre}-->" readonly=""></input>
                                </div>                                             
