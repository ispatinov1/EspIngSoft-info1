                ...
                <br><br>
                    <div id="panel-listaEstadosTipoSolicitud" class="panel panel-primary panel-table">
                        ...
                        <div class="panel-body">                
                            <div id="divTblEstadosTiposSolicitud" class="form-group">
                                <div class="table-responsive">                                                        
                                    <table class="tablesorter text-center" id="tblGestionSolicitudes" name="tblGestionSolicitudes" class="tablesorter text-center tablesorter-metro-dark ">                             
                                        <thead id="hTblEstadosTipoSolicitud" >
                                        ...
                                        <tbody id="bTblEstadosTipoSolicitud">                                   
                                        <!--{foreach from=$resultado item=estadosTipoSolicitud}-->                        
                                            <tr role="row">
                                                <td><!--{$estadosTipoSolicitud.sol_estadotsolicitud_id}--></td>
                                                <td><!--{$estadosTipoSolicitud.sol_estadotsolicitud_nombre}--></td>
                                                <td><!--{$estadosTipoSolicitud.sol_estadotsolicitud_descripcion}--></td>
                                                <td>                                                                                   
                                                    <a href="<!--{$modificar}-->'<!--{$estadosTipoSolicitud.sol_estadotsolicitud_id}-->'" class="btn btn-info btn-sm"> Modificar </a>                                            
                                                    <a href="<!--{$ver}-->'<!--{$estadosTipoSolicitud.sol_estadotsolicitud_id}-->'" class="btn btn-info btn-sm"> Ver </a>     
                                                    <a href="<!--{$eliminar}-->'<!--{$estadosTipoSolicitud.sol_estadotsolicitud_id}-->'" class="btn btn-info btn-sm"> Eliminar </a>
                                                </td>                                        
                                            </tr>                                
                                        <!--{/foreach}--> 
                                        </tbody>
