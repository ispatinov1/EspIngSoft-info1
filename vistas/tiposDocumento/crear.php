...
if($_POST['btnCrearTipoDocumento']){
    $resCrearTiposDocumento = $controlador->crear($_POST['txtNombreTipoDocumento'], $_POST['txtDescripcionTipoDocumento']);    
}

$titulo = utf8_encode('Gestión de tipos de documento');         
$subTitulo = utf8_encode('Crear tipo de documento');
$inicio = 'index.php';
$listar = '?carga=listar';
$crear  = '?carga=crear';
$buscar = '?carga=buscar';    
