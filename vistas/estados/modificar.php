...
if($_GET['id'] && !$_POST['btnModificarEstadoTipoSolicitud']){
    $resVerEstadosTipoSolicitud = $controlador->ver($_GET['id']);    
}
if($_POST['btnModificarEstadoTipoSolicitud']){     
    $resModificarEstadosTipoSolicitud = $controlador->editar($_POST['nbrIdEstadoTipoSolicitud'], $_POST['txtNombreEstadoTipoSolicitud'], $_POST['txtDescripcionEstadoTipoSolicitud']);    
    $resVerEstadosTipoSolicitud = $controlador->ver($_GET['id']); 
}

$titulo = utf8_encode('Gestión de estados por tipo de solicitud');         
$subTitulo = utf8_encode('Modificar estados para tipo de solicitud');
$inicio = 'index.php';
$listar = '?carga=listar';
$crear  = '?carga=crear';
$buscar = '?carga=buscar';    
...
$smarty->assign('resultado'     , $resVerEstadosTipoSolicitud);
