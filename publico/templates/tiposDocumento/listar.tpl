                ...
                <br><br>
                    <div id="panel-listaTiposDocumento" class="panel panel-primary panel-table">
                        ...
                        <div class="panel-body">                
                            <div id="divTblTiposDocumento" class="form-group">
                                <div class="table-responsive">                                                        
                                    <table class="tablesorter text-center" id="tblGestionSolicitudes" name="tblGestionSolicitudes" class="tablesorter text-center tablesorter-metro-dark ">                             
                                        ...
                                        <tbody id="bTblTiposDocumento">                                   
                                        <!--{foreach from=$resultado item=tiposDocumento}-->                        
                                            <tr role="row">
                                                <td><!--{$tiposDocumento.sol_tipodocumento_id}--></td>
                                                <td><!--{$tiposDocumento.sol_tipodocumento_nombre}--></td>
                                                <td><!--{$tiposDocumento.sol_tipodocumento_descripcion}--></td>
                                                <td>                                                                                   
                                                    <a href="<!--{$modificar}-->'<!--{$tiposDocumento.sol_tipodocumento_id}-->'" class="btn btn-info btn-sm"> Modificar </a>                                            
                                                    <a href="<!--{$ver}-->'<!--{$tiposDocumento.sol_tipodocumento_id}-->'" class="btn btn-info btn-sm"> Ver </a>     
                                                    <a href="<!--{$eliminar}-->'<!--{$tiposDocumento.sol_tipodocumento_id}-->'" class="btn btn-info btn-sm"> Eliminar </a>
                                                </td>                                        
                                            </tr>                                
                                        <!--{/foreach}--> 
                                        </tbody>
...
<!-- Fin Panel listado y gestion de tipos de documento -->
                </div>       