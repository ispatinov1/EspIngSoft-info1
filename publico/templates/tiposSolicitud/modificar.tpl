                        ...
                        <div class="well">                                
                            <form id="formCreaMotivosTipoSolicitud" name="formCreaMotivosTipoSolicitud" method="POST" action="" enctype="multipart/form-data" >
                                ...
                                <div id="divNombreMotivoTipoSolicitud" class="form-group" >
                                    ...
                                    <input type="text" id="txtNombreMotivoTipoSolicitud" name="txtNombreMotivoTipoSolicitud" class="form-control" maxlength="50" placeholder="Motivo por tipo de solicitud" value="<!--{$resultado.sol_motivotsolicitud_nombre}-->"></input>
                                </div>                                             
...
<!--{$resultado.sol_motivotsolicitud_descripcion}-->
                                ...
                                <div class="row text-center well well-md" >                                  
                                    <div id="btnModificarMotivoTipoSolicitud" class="col-md-6" >
                                        <input type="submit" id="btnModificarMotivoTipoSolicitud" name="btnModificarMotivoTipoSolicitud" class="btn btn-info" value="Modificar motivo tipo solicitud" >
                                    </div> 
