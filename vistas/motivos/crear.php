...
if($_POST['btnCrearMotivoTipoSolicitud']){
    $resCrearMotivosTipoSolicitud = $controlador->crear($_POST['txtNombreMotivoTipoSolicitud'], $_POST['txtDescripcionMotivoTipoSolicitud']);    
}
...
$smarty->assign('resultado'     , $resCrearMotivosTipoSolicitud);
