                    ...
                    <div class="panel-body">          
                        ...
                        <form id="formCreaEstadosTipoSolicitud" name="formCreaEstadosTipoSolicitud" method="POST" action="" enctype="multipart/form-data" >
                            ...
                            <div id="divNombreEstadoTipoSolicitud" class="form-group" >
                                ...
                                <input type="text" id="txtNombreEstadoTipoSolicitud" name="txtNombreEstadoTipoSolicitud" class="form-control" maxlength="50" readonly="" placeholder="Estado por tipo de solicitud" value="<!--{$resultado.sol_estadotsolicitud_nombre}-->"></input>
                            </div>                                             
...
<!--{$resultado.sol_estadotsolicitud_descripcion}-->
                            ...
                            <div class="row text-center well well-md" >                                  
                                <div id="divBtnEliminarEstadoTipoSolicitud" class="col-md-6" >
                                    <input type="submit" id="btnEliminarEstadoTipoSolicitud" name="btnEliminarEstadoTipoSolicitud" class="btn btn-info" value="Eliminar estado tipo solicitud" >
                                </div> 
